				...
				return (
					...
					>
						...
						<div className="flex gap-2 justify-between">
							<div className="flex gap-2 items-center">
								...
								<div className="flex flex-col">
									<div className="text-md font-bold max-w-[230px] overflow-ellipsis ">{plugin.name}</div>
									<div className="text-xs text-muted-foreground max-w-[230px] overflow-ellipsis truncate font-mono">By {plugin.owner}</div>
								</div>
							</div>
						...
						<div className="flex justify-between items-center">
							<div className="text-sm text-gray-50 overflow-ellipsis truncate max-h-[24px]">
								{plugin.description}
							</div>
						</div>
						<div className="flex justify-between items-center">
